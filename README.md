...
-Visiting Website 
Enter the URL http://localhost:{PORT NUMBER}/
...
Apply the steps above for the secured code and enter the elements (<img> and <form>) into the search bar and it should result into just plain text on the web page.
